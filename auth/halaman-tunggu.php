...
<body>
                ...
                <div class="card card-glass shadow-lg p-4 text-center">
                    ...
                    if ((int)$peminjam['verifikasi'] === 0) {
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-muted">Halo, <strong>{$peminjam['nama']}</strong>. Silahkan pergi keruangan sarpras untuk melanjutkan proses aktivasi akun kamu.</p>
                    ...
                    HTML;
                    } elseif ((int)$peminjam['verifikasi'] === 1) {
                        echo <<<HTML
                        <div class="mb-4">
                            <div class="display-1 text-success pulse-animation">
                                <i class="fas fa-check"></i>
                            </div>
                        </div>
                             <h2 class="fw-bold mb-2">Permintaan Diterima</h2>
                            <p class="text-muted">Halo, <strong>{$peminjam['nama']}</strong>. Selamat akun kamu sudah di verifikasi oleh sarpras!.</p>
                            <div class="text-start my-5 px-4">
                                <div class="d-flex align-items-center mb-4 step-active ps-3">
                                    <div class="me-3 bg-primary text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 35px; height: 35px;">
                                        <i class="fas fa-check"></i>
                                ...
                                <div>
                                <h6 class="mb-0 fw-bold">Verifikasi berhasil!</h6>
                                <small class="text-muted">sekarang kamu bisa akses semua fitur.</small>
                                </div>
                            </div>
                        </div>
                        <div class="border-top pt-4">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-3">
                            ...
                            <a href="login.php" class="btn btn-secondary rounded-pill">Lanjut Login</a>
                        </div>
                    </div>
                    HTML;
                    }
    ...
    <script>
        function checkStatus() {
            ...
            btn.innerHTML = '<i class="fas fa-spinner fa-spin me-2 animation-spin"></i> Mengecek...';
            btn.disabled = true;
